...
public class DefaultSqlSession implements SqlSession{
    ...
    public void dmlControl(String statementId, Object... params) throws Exception {
        SimpleExecutor simpleExecutor = new SimpleExecutor();
        simpleExecutor.dml(this.configuration,this.configuration.getMappedStatementMap().get(statementId), params);
    }
...
//                TODO 根据什么判断当前操作是增删改查
                SqlType sqlType = configuration.getMappedStatementMap().get(statementId).getSqlType();
                switch (sqlType){
                    case SELECT:
