...
public class SimpleExecutor implements Executor{
    ...
    public <E> List<E> query(Configuration configuration, MappedStatement mappedStatement, Object... params) throws Exception {
        PreparedStatement preparedStatement = detailConfiguration(configuration, mappedStatement, params);
        //执行sql
        ResultSet resultSet = preparedStatement.executeQuery();
        Class<?> resultTypeClass = this.getClasType(mappedStatement.getResultType());
    ...
    @Override
    public void dml(Configuration configuration, MappedStatement mappedStatement, Object... params) throws Exception {
        PreparedStatement preparedStatement = detailConfiguration(configuration, mappedStatement, params);
        preparedStatement.executeUpdate();
    }

    private PreparedStatement detailConfiguration(Configuration configuration, MappedStatement mappedStatement, Object... params) throws Exception {
